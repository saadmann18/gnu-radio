...
# Title: Hier Blocks and Parameters
...
class Hier_Blocks_Parameters(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Hier Blocks and Parameters", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Hier Blocks and Parameters")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Hier_Blocks_Parameters")
...
def main(top_block_cls=Hier_Blocks_Parameters, options=None):
