...
class LPF_example(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LPF example", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LPF example")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LPF_example")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_SQR_WAVE, frequency, 1, 0, 0)
...
def main(top_block_cls=LPF_example, options=None):
