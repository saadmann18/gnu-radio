...
class stream(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 0.1, 0, 0)
        ...
        self.connect((self.blocks_vector_to_streams_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
        self.connect((self.blocks_vector_to_streams_0, 1), (self.qtgui_time_sink_x_0_1_0_0, 0))
