...
class Design_filter_taps(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Design Filter Taps", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Design Filter Taps")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Design_filter_taps")
...
def main(top_block_cls=Design_filter_taps, options=None):
