...
# Title: Interpolation/ deicmation
...
class Interpolation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Interpolation/ deicmation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Interpolation/ deicmation")
        ...
        self.decimation_rate = decimation_rate = 4
        self.samp_rate_decimated = samp_rate_decimated = samp_rate * decimation_rate
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(decimation_rate, lowPassTaps)
        self.fir_filter_xxx_0.declare_sample_delay(0)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, samp_rate_decimated,True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_samp_rate_decimated(self.samp_rate * self.decimation_rate)
    ...
    def set_samp_rate_decimated(self, samp_rate_decimated):
        ...
        self.blocks_throttle_0.set_sample_rate(self.samp_rate_decimated)
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.samp_rate_decimated)
