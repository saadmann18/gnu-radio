...
class VariablesInFlowgraphsGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "VariablesInFlowgraphsGRC")
...
def main(top_block_cls=VariablesInFlowgraphsGRC, options=None):
