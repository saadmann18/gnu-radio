...
class StreamsAndVectorsGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "StreamsAndVectorsGRC")
        ...
        self.connect((self.blocks_vector_to_streams_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        self.connect((self.blocks_vector_to_streams_0, 1), (self.qtgui_time_sink_x_1_1, 0))
...
def main(top_block_cls=StreamsAndVectorsGRC, options=None):
