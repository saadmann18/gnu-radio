...
class HierBlocksAndParametersGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "HierBlocksAndParametersGRC")
...
def main(top_block_cls=HierBlocksAndParametersGRC, options=None):
