...
class RuntimeUpdatingVariablesGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RuntimeUpdatingVariablesGRC")
...
def main(top_block_cls=RuntimeUpdatingVariablesGRC, options=None):
