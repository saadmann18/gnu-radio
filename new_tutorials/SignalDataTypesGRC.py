...
class SignalDataTypesGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "SignalDataTypesGRC")
...
def main(top_block_cls=SignalDataTypesGRC, options=None):
