...
class UnPackingBitsGRC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "UnPackingBitsGRC")
...
def main(top_block_cls=UnPackingBitsGRC, options=None):
