...
class hadtest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "hadtest")
        ...
        # Create the labels list
        self._uiselect_labels = ['Soundcard', 'Test Signal']
        # Create the combo box
        ...
        self._uifreq_win = RangeWidget(self._uifreq_range, self.set_uifreq, "'uifreq'", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=hadtest, options=None):
